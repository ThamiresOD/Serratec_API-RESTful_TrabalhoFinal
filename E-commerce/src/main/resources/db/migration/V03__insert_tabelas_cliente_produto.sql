...
--Produto
INSERT INTO produto(prd_tx_nome, prd_tx_descricao, prd_int_quantidade_estoque, 
	prd_dt_data_cadastro, prd_nm_valor_unitario, prd_tx_url_produto, cat_cd_id) VALUES 
